...
public final class IlsCommand extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        case "createlore":
            ...
            addLoreItem(mp, Items.LEATHER_HELMET, new ArmourLore(), new DodgeLore(), new HealthLore(), new HealthRegenLore());
            addLoreItem(mp, Items.LEATHER_CHESTPLATE, new ArmourLore(), new DodgeLore(), new HealthLore(), new HealthRegenLore());
            addLoreItem(mp, Items.LEATHER_LEGGINGS, new ArmourLore(), new DodgeLore(), new HealthLore(), new HealthRegenLore());
            addLoreItem(mp, Items.LEATHER_BOOTS, new ArmourLore(), new DodgeLore(), new HealthLore(), new HealthRegenLore());
            break;
        case "stats":
